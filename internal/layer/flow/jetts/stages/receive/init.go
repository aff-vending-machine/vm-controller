...
func New(du usecase.Screen, ka api.Ksher, la api.Link2500, qh hardware.Queue, sr repository.Slot, tr repository.Transaction) *stageImpl {
	return &stageImpl{du, ka, la, qh, sr, tr, false, 0, 0, 0}
}
